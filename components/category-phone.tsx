...
const CategoryPhone = () => {
    ...
    return (
        <div>
            ...
            >
                <SwiperSlide >
                    <div className="m-1 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36">
                ...
                <SwiperSlide>
                    <div className="m-1 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36 ">
                        ...
                        <span >Mobiles & <br /> Gadgets</span>
                    </div>
                    <div className="m-1 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36 ">
                        <img src="./catergories/health.png" alt="" />
                        <span>Health & <br /> Personal Care</span>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="m-1 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36">
                    ...
                    <div className="m-1 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36">
                        ...
                        <span>Make up & <br /> Fragrance</span>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="m-1 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36">
                        <img src="./catergories/Entertainment.png" alt="" />
                        <span >Home <br /> Entertainment</span>
                    </div>
                    <div className="m-1 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36">
                ...
                <SwiperSlide>
                    <div className="m-1 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36 ">
                        ...
                        <span >Babies & <br /> Kids</span>
                    </div>
                    <div className="m-1 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36 ">
                        <img src="./catergories/Computers.png" alt="" />
                        <span>Laptop & <br /> Computers</span>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="m-1 pt-4 pr-2 pl-2 shadow-md sm:h-40 h-48 sm:w-auto w-36">
                ...
                <SwiperSlide>
                    ...
                    <div className="m-1 pt-4 pb-2 shadow-md sm:h-40 h-48 sm:w-auto w-36 ">
                        <img src="./catergories/hobbies.png" alt="" />
                        <span>Hobbies & <br /> Accessories</span>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="m-1 pt-4 pr-2 pl-2 shadow-md sm:h-40 h-48 sm:w-auto w-36">
